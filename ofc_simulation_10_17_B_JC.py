...
for i in range(1,53):
    if i == 2:  # DECISION: Special schedule for week 2 (Applies to first Monday of simulation)
...
# SIMULATION DECISION:
sim_until = 86401*7*3 # 1 day = 86400 seconds
...
env.process(save_logs(env, warehouse, sim_run_name, 86401*1))
#===============================================================================
