...
# SIMULATION DECISION:
sim_until = 86401*.5 # 1 day = 86401 seconds
...
# save logs to csv
if warehouse.logging:
    warehouse.log_processed_orders.to_csv('log_processed_orders.csv', index=False)
    warehouse.log_picker.to_csv('log_picker.csv', index=False)
    warehouse.log_packer.to_csv('log_packer.csv', index=False)
    warehouse.log_stower.to_csv('log_stower.csv', index=False)
#===============================================================================
